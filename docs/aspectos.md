...
Esta tabla contiene una declaración inicial. Debe ajustarse a los encabezados de la plantilla oficial del curso cuando esta sea suministrada.

| Aspecto de calidad | Descripción inicial |
|---|---|
| Seguridad | La plataforma debe proteger la identidad de los usuarios y la información de los pedidos, permitiendo que únicamente personas autorizadas consulten o modifiquen los datos correspondientes a su rol. |
